...
from keras.src.layers import LSTM, Dense, Bidirectional, BatchNormalization
...
class RepetitionSuggestorLSTMV1(HyperModel):
    ...
    def build(self, hp):
        ...
        model.add(Input(shape=(KerasRepetitionsSuggestorDataPreProcessor.SEQUENCE_LENGTH,
                               KerasRepetitionsSuggestorDataPreProcessor.FEATURES_NUMBER)))
...
class RepetitionSuggestorLSTMV2(HyperModel):
...
class RepetitionSuggestorLSTMV3(HyperModel):
