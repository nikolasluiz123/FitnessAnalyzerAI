...
class KerasCommonSuggestorDataPreProcessor(CommonDataPreProcessor, ABC):
    """
    Implementação para realizar os pré-processamentos necessários para que os dados possam ser passados para as redes
    neurais que serão treinadas.
    """
    ...
    def get_features_list(self) -> list[str]:
        """
        Função que deve retornar a lista das features que serão utilizadas pelas redes neurais treinadas com os dados que
        foram pré-processados.
        """

    @abstractmethod
    def get_target(self) -> str:
        """
        Função que deve retornar qual é o objetivo das redes neurais que serão treinadas, ou seja, qual o nome da coluna
        que ela deve prever.
        """
