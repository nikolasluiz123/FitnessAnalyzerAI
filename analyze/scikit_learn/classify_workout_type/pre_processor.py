...
class ScikitLearnClassifyWorkoutTypeDataPreProcessor(CommonDataPreProcessor):
    SEED = 42
    ...
    def get_features_and_target_to_train(self):
        ...
        x = df[['idade', 'genero', 'peso', 'altura', 'duracao_sessao', 'frequencia_treino', 'nivel_experiencia', 'percentual_gordura']]
        y = df['tipo_treino']
