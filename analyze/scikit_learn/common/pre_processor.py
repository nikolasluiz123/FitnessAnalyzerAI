...
class ScikitLearnCommonSuggestorDataPreProcessor(CommonDataPreProcessor, ABC):
    """
    Implementação de pré-processamento dos dados para treinamento de implementações de machine learning do scikit-learn.
    """
    ...
    def get_features_list(self) -> list[str]:
        """
        Função que deve retornar a lista das features que serão utilizadas no treinamento
        """

    @abstractmethod
    def get_target(self) -> str:
        """
        Função que deve retornar qual é o objetivo
        """
