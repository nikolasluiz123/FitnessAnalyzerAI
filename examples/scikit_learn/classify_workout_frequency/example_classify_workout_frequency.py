...
suggestor = ScikitLearnClassifyWorkoutFrequencyAgent(history_index=-1,
...
data = {
    ...
    'tipo_treino': ['Cardio', 'Strength', 'Yoga', 'HIIT', 'Cardio', 'Strength', 'Yoga', 'HIIT', 'Cardio',
                    'Strength', 'Yoga', 'HIIT', 'Cardio', 'Strength', 'Yoga', 'HIIT', 'Cardio', 'Strength',
                    'Yoga', 'HIIT'],
...
df['frequencia_treino'] = predictions
